			...
			<div class="col-md-4">
				<form action='search.php' method='post' role='form' class="form-inline offset-md-2">
					<div class="input-group text-center">
						<div class="col-md-12 input-group form-inline">
							<input type="text" name="search" class="form-control" placeholder="Search any post here">
							<span class="input-group-btn"><button type="submit" name="searchPost" class="btn btn-outline-danger">Search</button></span>
						</div>
					</div>
			    </form>
			</div>
						...
						<div class="col-md-12 rounded" style="background-color: #fff;">
							...
							<div class="row rounded" style="border: 1px solid transparent;">
								<div class="col-md-12">
									...
									<!-- function to display the searched post -->
									<?php searchPosts(); ?>
