    			...
    			<div class="col-md-10 offset-md-1" style="text-align: center; padding-top: 2%;">
					...
					<form action="" method="post" role="form" class="form">
						<div class="form-group signup-group">
							<input type="email" class="form-control signup-control" name="staff_email" placeholder="Email" required>
						</div>
						<div class="form-group signup-group">
							<input type="password" class="form-control signup-control" name="staff_password" placeholder="Password" required>
						</div>
						...
						if(isset($_POST['login'])){
							...
							if($check_staff==1){
								while($row = mysqli_fetch_assoc($run_select_staff)){
									...
									header("location: staff_area/index.php");
								} //while loop ends 
							} //if loop ends
							else{
					...
					<p>
						<a href="staff_reg.php">New to {{website}}? Sign up.</a>
					</p>
    			</div> <!-- col md 12 -->
    		</div> <!-- row -->
    	</div> <!-- container fluid -->
