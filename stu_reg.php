    	...
    	<div class="container-fluid">
    		<div class="row">
    			<div class="col-md-10 offset-md-1" style="text-align: center; padding-top: 2%;">
					...
					<p>
						<a href="stu_login.php">Have an account? Log in</a>
					</p>
					<form action="stu_reg.php" method="post" enctype="multipart/form-data" role="form" class="form">
						<div class="form-group signup-group">
							<input type="text" class="form-control signup-control" name="stu_name" placeholder="Full Name">
						</div>
						<div class="form-group signup-group">
							<input type="email" class="form-control signup-control" name="stu_email" placeholder="Email">
						</div>
						<div class="form-group signup-group">
							<input type="password" class="form-control signup-control" name="stu_password" placeholder="Password">
						</div>
...
<?php 
	...
	if(isset($_POST['signup'])){
		...
		$image_tmp = $_FILES['stu_image']['tmp_name'];

		move_uploaded_file($image_tmp, "images/$stu_image");
	
		$submit = "insert into members (designation, name, email, password, image, number_of_posts) values ('student' ,'$name', '$email', '$password', '$stu_image', '0')";
